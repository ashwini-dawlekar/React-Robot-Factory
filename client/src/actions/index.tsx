...
const FETCH_BATCH_URL = 'http://localhost:3000/api/robots';
const CREATE_SHIPMENT_URL = 'http://localhost:3000/api/shipment/create';
const EXTINGUISH_URL = 'http://localhost:3000/api/robots/extinguish';
const RECYCLE_URL = 'http://localhost:3000/api/robots/recycle';

export const fetchRobots = () => {
  let request = axios.default.get(FETCH_BATCH_URL);
  return {
    type: FETCH_ROBOTS,
    payload: request
  }
...
export const createNewShipment = (arrayOfIds) => {
  ...
  const request = axios.default.post(URL);
  return {
