...
var filterToCategory = function (robotItem, addToExtinguish, addToRecycle, updateRobotQaCategory, addApiToExtinguishFile, addApiToRecycleFile) {
    ...
    if (configuration.hasSentience && (_.indexOf(statuses, ROBOT_STATUS.ON_FIRE) > -1)) {
        ...
        updateRobotQaCategory(id, index_1.ADD_TO_EXTINGUISH);
    ...
    if (hasFewerThan3GreaterThan8Rotors(configuration) ||
        ...
        updateRobotQaCategory(id, index_1.ADD_TO_RECYCLED);
...
var sortForShipping = function (robot, updateRobotQaCategory) {
    ...
    if (isRusty(statuses) || hasLooseScrews(statuses) || hasScratchedPaint(statuses)) {
        updateRobotQaCategory(id, index_1.ADD_TO_FACTORY_SECOND);
    }
    else {
        updateRobotQaCategory(id, index_1.ADD_TO_QA_PASS);
    }
};
exports.categorizeRobots = function (robotsArray, addToRecycle, addToExtinguish, updateRobotQaCategory, addApiToExtinguishFile, addApiToRecycleFile) {
    ...
    var robotsForShipping = index_2.default.getState().robots.filter(function (robot) {
